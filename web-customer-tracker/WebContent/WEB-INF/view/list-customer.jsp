...
<%@ page import="com.huzaifabinzahoor.springdemo.utility.SortUtils"%>
	...
	<div id="container">
		<div id="content">
			...
			<table>
				...
				<c:url var="sortLinkFirstName" value="/customer/listBySorting">
					<c:param name="sort"
						value="<%=Integer.toString(SortUtils.FIRST_NAME)%>" />
				</c:url>

				<!-- construct a sort link for last name -->
				<c:url var="sortLinkLastName" value="/customer/listBySorting">
					<c:param name="sort"
						value="<%=Integer.toString(SortUtils.LAST_NAME)%>" />
				</c:url>

				<!-- construct a sort link for email -->
				<c:url var="sortLinkEmail" value="/customer/listBySorting">
